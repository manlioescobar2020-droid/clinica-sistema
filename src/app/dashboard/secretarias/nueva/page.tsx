...
import { createSecretary } from "@/lib/actions/secretaries"
    ...
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-2xl mx-auto">
        <div className="mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mt-2">Nueva Secretaria</h1>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-sm p-8 space-y-6">
          ...
          >
            {loading ? "Creando secretaria..." : "Crear Secretaria"}
          </button>
        </form>
      </div>
    </div>
